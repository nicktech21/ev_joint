...
<Box className={classes.login_container_fp}>
            ...
            className={classes.welcome_text}>Forget Password</Text>
...
<Dialog
        open={isOpenDialog}
        onClose={onDialogClose} title ="OTP Sent" disableCloseIcon  icon={iconData} children={<OTPSendModal formError={formError} />} />
